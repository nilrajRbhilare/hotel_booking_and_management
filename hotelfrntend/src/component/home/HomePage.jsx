        ...
        <div className="home">
            ...
            {/* <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="Nil's Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Nil's Hotel</span>
                        </h1><br />
 ...
 <header className="header-banner">
    ...
    <div className="animated-texts overlay-content">
      ...
      <h3>Step into a haven of comfort and care</h3>
           ...
           <h2 className="home-services">Services at <span className="phegon-color">Nil's Hotel</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src="src\assets\images\aircon2.jpeg" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src="src\assets\images\minBar2.jpeg" alt="Mini Bar" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src="src\assets\images\parking.jpg" alt="Parking" />
                    <div className="service-details">
